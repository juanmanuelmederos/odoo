...
TAGs are prefix to your commit. They should be one of the following
...
- **[ADD]** for adding new resources: like adding new file, new views, new models,
  new module;
...
- **[MERGE]** for merge commits: used in forward port of bug fixes but also as
  main commit for feature involving several separate commits;
...
First exaplin WHY you are modifying code. What is important if someone goes back
