...
class TestGetActiveRecords(common.TransactionCase):
    ...
    def test_get_active_records(self):
        ...
        active_domain_records = res_partner.with_context({'active_domain': domain, 'all_selected': True, 'active_model': 'res.partner'}).get_active_records()
        ...
        all_records = res_partner.with_context({'active_domain': [], 'all_selected': True, 'active_model': 'res.partner'}).get_active_records()
