   ...
   Only allowed people can contact us at this address.</p>
    ...
    def message_post_with_view(self, views_or_xmlid, **kwargs):
        ...
        for record in self:
            ...
            rendered_template = views.render(values, engine='ir.qweb', skip_full_ctx=True)
    ...
    def _message_auto_subscribe_notify(self, partner_ids):
        ...
        for record in self:
            ...
            assignation_msg = assignation_tpl.render(values, engine='ir.qweb', skip_full_ctx=True)
