...
class Alias(models.Model):
    ...
    alias_domain = fields.Char('Alias domain', compute='_get_alias_domain',
                               default=lambda self: self.env['mail.thread']._get_mail_config_parameter("mail.catchall.domain"))
    ...
    def _get_alias_domain(self):
        alias_domain = self.env['mail.thread']._get_mail_config_parameter("mail.catchall.domain")
        for record in self:
