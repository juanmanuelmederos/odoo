    ...
    def _send(self, auto_commit=False, raise_exception=False, smtp_session=None):
        ...
        for mail_id in self.ids:
            try:
                ...
                # headers
                headers = {}
                bounce_alias = self.env['mail.thread']._get_mail_config_parameter("mail.bounce.alias")
                catchall_domain = self.env['mail.thread']._get_mail_config_parameter("mail.catchall.domain")
