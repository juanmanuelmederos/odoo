        ...
        window.onerror = function (message, file, line, col, error) {
            ...
            if (!file && !line && !col) {
                if (message === "Script error." && !error) {
                    // Chrome and Opera set this specific string on the window.onerror message variable
                    // alert('CHROME AND OPERA');
                } else if (error) {
                    // Firefox set this specific string on the window.onerror message variable
                    // alert('FIREFOX');
                }
