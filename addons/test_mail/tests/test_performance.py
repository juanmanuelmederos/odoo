...
class TestAdvMailPerformance(TransactionCase):
    ...
    def test_message_assignation_email(self):
        ...
        with self.assertQueryCount(admin=92, emp=118):  # test_mail only: 85 - 110
            record.write({
    ...
    def test_message_assignation_inbox(self):
        ...
        with self.assertQueryCount(admin=51, emp=66):  # test_mail only: 49 - 59
            record.write({
                'user_id': self.user_test.id,
            })
    ...
    def test_message_log_with_post(self):
        ...
        with self.assertQueryCount(admin=28, emp=39):  # test_mail only: 25 - 35
            record.message_post(
    ...
    def test_message_post_one_email_notification(self):
        ...
        with self.assertQueryCount(admin=80, emp=108):  # com runbot 78 - 106 // test_mail only: 75 - 102
            record.message_post(
    ...
    def test_message_post_one_inbox_notification(self):
        ...
        with self.assertQueryCount(admin=41, emp=53):  # com runbot 39 - 51 // test_mail only: 39 - 49
            record.message_post(
    ...
    def test_message_subscribe_default(self):
        ...
        with self.assertQueryCount(admin=7, emp=8):  # test_mail only: 6 - 6
            record.message_subscribe(partner_ids=self.user_test.partner_id.ids)

        with self.assertQueryCount(admin=19, emp=19):  # test_mail only: 3 - 3
            record.message_subscribe(partner_ids=self.user_test.partner_id.ids)
    ...
    def test_message_subscribe_subtypes(self):
        ...
        with self.assertQueryCount(admin=7, emp=8):  # test_mail only: 5 - 5
            record.message_subscribe(partner_ids=self.user_test.partner_id.ids, subtype_ids=subtype_ids)

        with self.assertQueryCount(admin=19, emp=19):  # test_mail only: 14 - 14
            record.message_subscribe(partner_ids=self.user_test.partner_id.ids, subtype_ids=subtype_ids)
...
class TestHeavyMailPerformance(TransactionCase):
    ...
    def test_complex_tracking_assignation(self):
        ...
        with self.assertQueryCount(admin=94, emp=122):  # test_mail only: 87 - 113
    ...
    def test_complex_tracking_subscription_create(self):
        ...
        with self.assertQueryCount(admin=273, emp=323):  # test_mail only: 238 - 286
            rec = self.env['mail.test.full'].create({
                'name': 'Test',
    ...
    def test_complex_tracking_subscription_subtype(self):
        ...
        with self.assertQueryCount(admin=230, emp=268):  # test_mail only: 147 - 170
            rec.write({
                'name': 'Test2',
                'umbrella_id': self.umbrella.id,
                })
    ...
    def test_complex_tracking_subscription_write(self):
        ...
        with self.assertQueryCount(admin=184, emp=213):  # test_mail only: 153 - 180
            rec.write({
                'name': 'Test2',
                'umbrella_id': umbrella_id,
                'customer_id': customer_id,
    ...
    def test_complex_tracking_template(self):
        ...
        with self.assertQueryCount(admin=65, emp=92):  # test_mail only: 58 - 81
            rec.write({
                'name': 'Test2',
                'customer_id': customer_id,
                'user_id': self.env.uid,
