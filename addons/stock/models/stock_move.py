    ...
    def action_show_details(self):
        ...
        return {
            ...
            'context': dict(
                ...
                show_source_location=self.location_id.child_ids and self.picking_code == 'incoming',
                show_destination_location=self.location_dest_id.child_ids and self.picking_code == 'outgoing',
